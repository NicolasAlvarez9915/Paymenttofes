...
namespace Infraestructura
{
    public class Excel
    {
        public void GenerarReporteClientes(List<Cliente> clientes)
        {
            ...
            worbook.SaveAs(@"C:\Reportes Paymenttofees\ReporteClientesActual.xlsx");
        }
        public void GenerarReporteCreditos(List<Credito> creditos)
        {
            ...
            int i = 3;
            worShet.Cell($"A1").Value = $"Reporte {DateTime.Now.ToString()} ";
            worShet.Cell("A2").Value = "Id_Credito";
            ...
            foreach (Credito credito in creditos)
            {
                ...
                worShet.Cell($"B{i}").Value = credito.Id_Cliente;
            ...
            worbook.SaveAs(@"C:\Reportes Paymenttofees\ReporteCreditosActual.xlsx");
        }
        ...
        public void GenerarReportePagos(List<Pago> Pagos)
        {
            ...
            worbook.SaveAs(@"C:\Reportes Paymenttofees\ReportePagosActual.xlsx");
        }
    }
}
